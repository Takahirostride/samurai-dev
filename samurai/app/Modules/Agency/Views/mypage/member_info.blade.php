					...
					<div class="row">
						<div class="tab-memberinfo">
							<ul class="nav profile-tab-new nav-tabs">
								<li class="active"><a href="{{URL::route('agency.memberinfo')}}">ログイン情報設定</a></li>
								<li><a href="{{ URL::route('agency.memberinfo.mail') }}">メール通知設定</a></li>
...
@section('script')
	<script>
		...
		var saveEmail = function() {
			...
			$.ajax({
				url: base_url + '/agency/mypage/memberinfo-ajax',
