							...
							<div class="profile-reg-form text-center">
							    ...
							    <dl class="row">
							        ...
							        <dd class="col-sm-3">
							        	...
							        	{{ Form::select('agency_type_id', App\Models\AgencyType::pluck('agency_type', 'id'), $user->agency_type_id, ['class'=>'form-control'] ) }}
							        	</div>
							        </dd>
							    </dl>
							    <!-- <dl class="row">
							        ...
							        <dd class="col-sm-8">
							        	{{ Form::input('text', 'agency_register_number', $user->agency_register_number , ['class'=>'form-control', 'placeholder'=>'書士会登録番号']) }}
							        </dd>
							    </dl>
							    <dl class="row">
							        <dt class="col-sm-4">
							        ...
							        <dd class="col-sm-8">
							        	{{ Form::input('text', 'zip_code', $user->zip_code , ['class'=>'form-control', 'placeholder'=>'郵便番号(数字7桁)']) }}
							        </dd>
							    </dl> -->
							    <dl class="row">
							        <dt class="col-sm-4">
