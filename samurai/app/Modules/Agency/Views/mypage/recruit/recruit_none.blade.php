					...
					<div class="col-sm-9">
						<div class="detail-hire">
							<div class="djob-navbar">
								<a href="{{URL::route('agency.recruitment')}}" class="">進んでいる案件</a>
								<a href="{{URL::route('agency.recruitment.received')}}">依頼が来た案件 <span class="badge">3</span></a>
								<a href="{{URL::route('agency.recruitment.requested')}}">提案した案件</a>
