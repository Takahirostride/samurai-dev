			...
			<div class="col-sm-10 mainpage">
				...
				<div class="row">
                	...
                	<div class="col-sm-12">
                		...
                		<div class="row">
                			<div class="col-xs-4">
                				<div id="update_date_pick" data-date="{{request()->update_date}}" class="datepickertoday"></div>
                                {{Form::input('hidden', 'update_date', request()->update_date, ['class'=>'form-control', 'id'=>'update_date', 'data-date-format'=>'YYYY/MM/DD'] )}}
		                					...
		                					<div class="row">
		                						<div class="col-sm-3">
		                							<span class="button-checkbox">
												        ...
												        {{Form::checkbox('work_set_task[]', 0, false, ['class'=>'hidden work_task'] )}}
												    </span>
		                						</div>
		                						<div class="col-sm-3">
		                							<span class="button-checkbox">
												        <button type="button" class="btn btn-ncheckbox" data-color="success">提出書類</button>
												        {{Form::checkbox('work_set_task[]', 1, false, ['class'=>'hidden work_task'] )}}
												    </span>
												</div>
		                						<div class="col-sm-3">
		                							<span class="button-checkbox">
												        <button type="button" class="btn btn-ncheckbox" data-color="success">本申請</button>
												        {{Form::checkbox('work_set_task[]', 2, false, ['class'=>'hidden work_task'] )}}
												    </span>
												</div>
		                						<div class="col-sm-3">
		                							<span class="button-checkbox">
												        <button type="button" class="btn btn-ncheckbox" data-color="success">採択日</button>
												        {{Form::checkbox('work_set_task[]', 3, false, ['class'=>'hidden work_task'] )}}
												    </span>
												</div>
		                					</div> <!-- end .row -->
		                					<div class="row">
		                						<div class="col-sm-3">
		                							<span class="button-checkbox">
												        ...
												        {{Form::checkbox('work_set_task[]', 4, false, ['class'=>'hidden work_task'] )}}
												    </span>
												</div>
		                						<div class="col-sm-3">
		                							<span class="button-checkbox">
												        <button type="button" class="btn btn-ncheckbox" data-color="success">受給</button>
												        {{Form::checkbox('work_set_task[]', 5, false, ['class'=>'hidden work_task'] )}}
												    </span>
												</div>
		                						<div class="col-sm-3">
		                							<span class="button-checkbox">
												        <button type="button" class="btn btn-ncheckbox" data-color="success">確定通知書</button>
												        {{Form::checkbox('work_set_task[]', 6, false, ['class'=>'hidden work_task'] )}}
												    </span>
												</div>
		                						<div class="col-sm-3">
		                							<span class="button-checkbox">
												        <button type="button" class="btn btn-ncheckbox" data-color="success">支払</button>
												        {{Form::checkbox('work_set_task[]', 7, false, ['class'=>'hidden work_task'] )}}
												    </span>
												</div>
		                					</div> <!-- end .row -->
		                					<div class="row">
		                						<div class="col-sm-3">
		                							<span class="button-checkbox">
												        ...
												        {{Form::checkbox('is_checked', 1, false, ['class'=>'hidden', 'id'=>'is_checked'] )}}
												    </span>
												</div>
		                						<div class="col-sm-9">
		                							{{Form::text('other_cb', '', ['class'=>'form-control', 'placeholder'=>'上記以外'] )}}
		                						</div>
		                					</div> <!-- end .row -->
		                				</div> <!-- end .col-sm-10 -->
		                		</div> <!-- end .row -->
		                				...
		                				<div class="row">
		                					<div class="col-sm-3">
	                							<span class="button-checkbox">
											        ...
											        {{Form::checkbox('notify_day[]', 1, false, ['class'=>'hidden cbnotify_day'] )}}
											    </span>
											</div>
											<div class="col-sm-3">
	                							<span class="button-checkbox">
											        <button type="button" class="btn btn-ncheckbox" data-color="success">1日前</button>
											        {{Form::checkbox('notify_day[]', 2, false, ['class'=>'hidden cbnotify_day'] )}}
											    </span>
											</div>
											<div class="col-sm-3">
												<span class="button-checkbox">
											        <button type="button" class="btn btn-ncheckbox" data-color="success">2日前</button>
											        {{Form::checkbox('notify_day[]', 3, false, ['class'=>'hidden cbnotify_day'] )}}
											    </span>
											</div>
											<div class="col-sm-3">
												<span class="button-checkbox">
											        <button type="button" class="btn btn-ncheckbox" data-color="success">なし</button>
											        {{Form::checkbox('notify_day[]', 4, false, ['class'=>'hidden cbnotify_day'] )}}
											    </span>
											</div>
		                				</div> <!-- end .row -->
		                			</div><!-- end .col-sm-9 -->
