						...
						<ul class="tallList">
							...
							<li>
								<div id="divs-{{$work->id}}" class="text-center {{$class}}">
									<a onclick="return false" href="#" class="@if($work->complete_flag)active @endif ">
						    ...
						    <tbody>
							    <tr>
							        <td class="text-center">
									    ...
									    <button type="button" class="shadowbuttonprimary btn btn-primary">完了</button>
									    @else
										<button type="button" class="shadowbuttonprimary btndisabled btn btn-primary">未完了</button>
									    @endif
							        </td>
