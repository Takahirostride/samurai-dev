			...
			<div class="col-sm-10 mainpage">
				<div class="col-sm-12 div-style-blue2">
			        <div class="row">     
			            ...
			            <div class="col-sm-1">
			       　　 		<img src="/assets/common/images/manual.png" class="mb20" height="40px" data-toggle="modal" data-target="#modal-registration-policy1">
			            </div>
			        </div>
		        </div>
				<div class="row subsidy-list">
					<div class="col-sm-12">
					{{ Form::open(['url' => '/agency/Csubsidylist', 'method' => 'GET', 'enctype'=>'multipart/form-data']) }}
