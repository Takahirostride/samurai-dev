			...
			<div class="jumbotron-button-list">
				<div class="row">
					...
					<div class="col-sm-5">
						...
						<a href="{{route('agency.DclientRequest')}}" class="btn btn-primary shadowbuttonblue mgt-30"  data-toggle="tooltip"{{--  data-placement="bottom" data-original-title="あなたが対応可能な施策（助成金・補助金）を登録することで、事業者から検索されやすくなります。またSAMURAIに登録されていない施策をあなたが登録すること優先的に仕事依頼が来ます。" --}}>
				...
				<table class="table table-hover table-bordered">
					<tbody>
						...
						<tr>
							...
							{{-- <td><a href="{{URL::route('agency.notify', [$no->id] )}}">{{ $no->title }}</a></td> --}}
							<td>{{ $no->title }}</td>
						</tr>
						@endforeach
					</tbody>
										...
										<td style="border-left: none">
											<div class="row">
												...
												<div class="col-sm-4 text-right">
													<a href="{{route('agency.bselect', ['policy_id' => $val->policy->id])}}" class="btn btn-default btn-suggest">提案する</a>
...
@section('script')
	...
	@if(\Request::route()->getName() == 'agency.home_lock') {
		<script>
