	...
	<div class="bl-policy-budget">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
				<p class="txt-cir"><span class="circle">支援内容</span>{!! strip_tags($val->support_content) !!}</p>
				<p class="txt-cir"><span class="circle">支援規模</span>{!! strip_tags($val->support_scale) !!}</p>
