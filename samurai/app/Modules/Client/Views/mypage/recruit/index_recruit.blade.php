				...
				<div class="row">
					...
					<div class="col-sm-9">
						<div class="detail-hire">
							...
							@include('Client::mypage.recruit.index_recruit.payment_table')
							{{ Form::close() }}
							</div>
						    ...
						    <tbody>
							    <tr>
							        <td class="text-center">
									    ...
									    <button type="button" data-id="{{$work->id}}" class="shadowbuttonprimary btn btn-primary">完了</button>
									    @else
										<button type="button" data-id="{{$work->id}}" class="shadowbuttonprimary btndisabled btn btn-primary ">未完了</button>
									    @endif
							        </td>
...
@section('script')
	<script>
		...
		var currentEl;
		var work_set = [];
		var targetReload = '/client/mypage/recruitment';
		var finishRoute = '/client/mypage/recruitment/finished/';
		var recruitAjax = '/client/mypage/recruitment-ajax';

		var taskAjax = '/client/mypage/jobs/matching-case/task-setting-ajax';
		var workSetAjax = '/client/mypage/recruitment-workset-ajax';
		...
		var cancelMatchingAjax = '/client/recruitment/cancel-matching';
