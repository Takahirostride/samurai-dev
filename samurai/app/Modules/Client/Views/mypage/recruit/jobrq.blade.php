				...
				<div class="row">
					...
					<div class="col-sm-9">
						<div class="detail-hire">
								...
								<tbody>
									...
									<tr>
										<td class="left-padding-job" colspan="2">
											...
											<button data-toggle="modal" data-target="#cancelMatching" type="button" class="btn btn-danger btn-samurai pull-right big-button">依頼を取り下げる</button>
							...
							<div class="title-blue"><span class="text">士業名：{{$selectedHire->user->displayname}}</span></div>
							<table class="table table-date-policy table-bordered">
								<tbody>
									<tr>
										<td class="left-padding-job">
