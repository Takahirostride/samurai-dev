					...
					<div class="row">
						<div class="tab-memberinfo">
							<ul class="nav profile-tab-new nav-tabs">
								...
								<li class="active"><a href="{{ URL::route('client.memberinfo.block') }}">ブロック</a></li>
						...
						<div class="col-sm-12 form-memberinfo memberinfo-2">
								...
								{{Form::open(['method'=>'POST', 'url'=>URL::to('/client/mypage/memberinfo/add-block')])}} 
									<div class="row">
										<div class="col-sm-3">
											<p>ユーザー名</p>
										</div>
							...
							<div class="col-sm-12 form-memberinfo last">
								{{Form::open(['method'=>'POST', 'url'=>URL::to('/client/mypage/memberinfo/remove-block')])}} 
									<div class="col-sm-3">
										<p>ブロックリスト</p>
									</div>
									<div class="col-sm-9">
...
@section('script')
	<script>
		...
		var doSearchUser = function() {
			$.ajax({
				url: base_url + '/client/mypage/memberinfo/block-ajax',
