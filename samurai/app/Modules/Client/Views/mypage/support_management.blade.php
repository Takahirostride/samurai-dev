	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-10 mainpage">
                ...
                {{ Form::open(array('url' => '/client/mypage/payment', 'method' =>'GET')) }}
                <div class="row">
                    <div class="col-sm-2">
                ...
                {{ Form::close() }}
                {{ Form::open(array('url' => route('client.payment.invoice'), 'method' =>'GET')) }}
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-sm-12 mgt-20">
                        <table class="table table-bordered table-hover" style="margin-bottom: 20px"> 
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    <td>@if($value->paid_status == 0) <input type="radio" class="check_" name="payment_id[]" value="{{$value->id}}">@endif </td>
                    ...
                    <div class="col-sm-12 box-agen-green mb20">
                        ...
                        <input type="hidden" name="back_link" value="{{URL::route('client.payment.support_management')}}">
                        <p>下記より、請求書をダウンロードして、支払を完了してください。<br>
                            ※着手金の支払いの場合、着手金の支払いが完了すると、仕事管理の「進んでいる案件」から案件を進める事がができます。<br>
                            依頼金額の返金は <a href="{{URL::to('inquiry')}}" target="_blank">問い合わせ</a> よりご連絡ください。</p>
                        <p class="text-center"><input type="submit" name="submit" id="click-btn" value="請求書を確認する" class="btn-primary btn btn-style-shadow-green btn-success"></p>
                    </div>
                </div>
