							        			...
							        			<tr>
							        				<td class="text-left">
							        					<div class="checkbox no-mgr">
							        						<label>
							        							<input type="checkbox" name="user_business[]" value="{{$trade[$ii]['id']}}" @if(in_array($trade[$ii]['id'], $user_business )) checked="checked" @endif disabled="disabled">
							        							{{$trade[$ii]['trade']}}
							        						</label>
							        					</div>
							        				...
							        				<td class="text-left">
							        					...
							        					<div class="checkbox no-mgr">
							        						<label>
							        							<input type="checkbox" name="user_business[]" value="{{$trade[$ii+1]['id']}}" @if(in_array($trade[$ii+1]['id'], $user_business )) checked="checked" @endif disabled="disabled">
							        							 {{$trade[$ii+1]['trade']}} 
							        						</label>
							        					</div>
							        					@endif
...
プロフィールの変更を行いますか？</p>
				...
				<div class="pbtn-area text-center">
					...
					<a class="btn btn-samurai btn-warning" href="{{URL::route('client.profile.edit')}}">変更する</a>
				</div>
			</div>
		</div>
	</div>
