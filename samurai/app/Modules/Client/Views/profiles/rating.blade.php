	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<p class="page-description">士業過去の評価実績を表示しています。</p>
			</div>
		</div>
		<div class="row">
				@if($user->image)
				...
				<div class="row">
					<div class="col-sm-12">
						<ul class="nav profile-tab-new nav-tabs">
							...
							<li class=""><a href="{{ URL::route('client.profile.view.availabletask', ['agency_id'=> $agency_id]) }}">対応可能業務</a></li>
							<li class="active"><a href="{{ URL::route('client.profile.view.rating', ['agency_id'=> $agency_id]) }}">評価・実績</a></li>
						</ul>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="block-evaluation text-center mypageagency">
		                    ...
		                    <div class="col-sm-3">
		                        ...
		                        <p>1ヶ月 : {{ $rating_info['evaluate_a_month'] }}</p>
		                        <p>半年： {{ $rating_info['evaluate_a_half_year'] }}</p>
		                        </div>
		                    </div>
		                    <div class="col-sm-3">
		                        <div class="row evaluation">
...
{{ HTML::script('assets/agency/js/mypage_home.js') }}
	<script>
		...
		var saveResult = function() {
			...
			$('#result-form').addClass('e-hidden');
			$.ajax({
				url: base_url + '/agency/mypage/profile/rating-ajax',
