                        ...
                        <div class="site-content">
                            ...
                            <div class="section-2 col-md-12">
                                ...
                                <div class="col-md-11">
                                    <div class="form-group" style="margin-top:30px;">
                                        ...
                                        <p class="c">@if(!empty(@$data->staff_id)) {{@$data->staff_id}} @else 自動で割り当てる @endif</p>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-top:20px;">
                                        ...
                                        <div class="col-sm-5">
                                            {{Form::text('employeepassword', '', ['class'=>'form-control', 'placeholder'=>'8文字以上', 'required'=>'required', 'minlength'=>8, 'type'=>'password', 'id'=>'inputPassword'])}}
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-top:20px;">
                                        <p class="col-sm-4">(確認)</p>
                                        <div class="col-sm-5">
                                            {{Form::text('employeepasswordverify', '', ['class'=>'form-control', 'required'=>'required', 'minlength'=>8, 'type'=>'password', 'data-match'=>'#inputPassword'])}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-bottom:20px;">
                                <div class="col-sm-12">
                                    ...
                                    {{ Form::open(['url' => '/admin/master/employeeedit', 'method' => 'GET', 'class' => 'form-horizontal']) }}
