					...
					<td>
						<div class="tb-contain tb-date">
							...
							<div class="tb-cell">
								...
								<span class="ip33_day">
									{!! Form::select('e_day',$days,$request->query('e_day',null),['class'=>'form-control','placeholder'=>'日にちを指定する']) !!}
								</span>									
							</div>
						</div>
					</td>
				...
				<tr>
					...
					<td>
						<div class="form-group">	
							<div class="cb_multi">
								{!! Form::select('status', config('combobox.payplan_statuses') , $request->query('status',null),['class'=>'form-control']) !!}
							</div>
						</div>						
					</td>
				</tr>
