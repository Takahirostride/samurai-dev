                                ...
                                <div class="section3-full">
                                    <div class="section3-full-scroll">
                                        <div class="row" style="margin-bottom:20px;">
                                            ...
                                            {{ Form::open(['url' => '/admin/employee/system/alimedit', 'method' => 'POST', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data']) }}
                                            ...
                                            <div class="tab-content" style="border:1px solid #000;">
                                                <div class="col-sm-12 tab-pane active" id="tab1">
                                                    <div class="col-sm-12" style="padding-top:10px;">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="datepicker" id="datepicker1"  data-date="{{$result->created_date}}"></div> 
                                                            {{Form::hidden('created_date', $result->created_date, ['id'=>'showdayinput'])}}
                                                        </div>
                                                    </div>
