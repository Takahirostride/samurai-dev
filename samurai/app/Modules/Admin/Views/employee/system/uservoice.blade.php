                        ...
                        <div class="site-content">
                            ...
                            <div class="section-3 col-md-12">
                                <div style="float:left;padding-left:100px;">
                                   <a class="submit-blue-btn" href=" {{URL::to('/admin/employee/system/uservoiceadd')}}">新規追加</a>
                                </div>
                            </div>
                            {{ Form::open(['url' => '/admin/employee/system/uservoice', 'method' => 'POST', 'class' => 'form-horizontal']) }}
                            <div class="section-3 col-md-12">
                                        ...
                                        @if (!empty($result))
                                            ...
                                            <div class="row" style="margin-bottom:20px;">
                                                ...
                                                <div class="col-sm-11">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-2">
                                                         <a class="submit-blue-btn" href=" {{URL::to('/admin/employee/system/uservoiceedit/'.$val->id)}}">詳細設定</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                          {{-- {{FORM::text('order['.$val->id.']', $val->order, ['class'=>'form-control', 'placeholder' => '表示順'])}} --}}
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <div class="angularsl">
                                                        ...
                                                        <div class="col-sm-2">
                                                         <a class="btn btn-danger btn-style-shadow-red" href=" {{URL::to('/admin/employee/system/uservoicedelete/'.$val->id)}}">削除する</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
