                        ...
                        <div class="sidebar-left">
                            <ul>
                                <ul>
	                                ...
	                                <li class="active"><a href="{{URL::to('/admin/employee/system/tag')}}">タグ管理</a></li>
                    ...
                    <div class="col-md-9 pull-right">
                        <div class="site-content">
                            ...
                            <div id="content-nav">
                                <div class="horizontal-menu navbar-collapse collapse ">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li><a style="width: 200px" class="active" href="{{URL::to('/admin/employee/system/tag')}}">タグ</a></li>
                            ...
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">項目設定管理</legend>

                                <div class="control-group" style="margin-bottom:20px;">
                                    {{ Form::open(['url' => '/admin/employee/system/tag', 'method' => 'POST', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data']) }}
                                    <div class="controls">
                                        <div class="col-sm-7" style="padding-left: 0px;">
                                            <div class="col-sm-7" style="margin-top: 2px; padding-left: 0px;">
                                                <p class="col-sm-3" style="padding-left: 0px;">業種:</p>
                                                {{Form::text('tag', '', ['class'=> 'col-sm-9'])}}
                                                {{Form::hidden('id', '')}}
                                            </div>
                                ...
                                {{ Form::open(['url' => '/admin/employee/system/tagstatus', 'method' => 'POST', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data']) }}
                                <div class="control-group" style="margin-bottom:20px;">
                                    <div class="controls">
                                    ...
                                    <tbody>
                                        @if (!empty($result))
                                            ...
                                            <tr id="tr_{{$val->id}}" class="edittr">
                                                ...
                                                <td onclick="editindustrycontent('{{$val->id}}','{{$val->tag}}','{{$val->order}}')">{{$index+1}}</td>
                                                <td onclick="editindustrycontent('{{$val->id}}','{{$val->tag}}','{{$val->order}}')">{{$val->tag}}</td>
                                                <td onclick="editindustrycontent('{{$val->id}}','{{$val->tag}}','{{$val->order}}')">{{$val->display}}</td>
                                            </tr>
                                            @endforeach
                                        @endif
                                    </tbody>
...
@section('script')
    <script>
            function editindustrycontent(id, tag, order) {
            ...
            function rssubmit(id, tag, order) {
