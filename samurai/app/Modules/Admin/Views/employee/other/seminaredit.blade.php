        ...
        <div class="inner-content">
            <div class="inner-container">
                <div class="row">
                    ...
                    <div class="site-content">
                        {{ Form::open(['url' => '/admin/employee/other/seminaredit', 'method' => 'POST', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data']) }}
                        <div class="add-container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right" style="height:40px;">
                                        <p style="font-size:14px;">{{$seminar->id}}{{Form::hidden('id', $seminar->id)}}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right">
                                        {{Form::text('event_name', $seminar->event_name, ['class'=>'form-control'])}}
                                    </div>
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right">
                                        ...
                                        <div class="col-md-7" style="z-index: 0;">
                                            <div class="datepicker" id="datepicker1" data-date="{{$seminar->date}}"></div> 
                                            {{Form::hidden('date', $seminar->date, ['id'=>'showdayinput'])}}
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right" style="height:40px;">
                                        ...
                                        <div class="col-md-4" style="z-index: 1;">
                                            <div class="angularsl">
                                                {{Form::select('time_start', config('combobox.timelist'), $seminar->time_start)}}
                                            </div>
                                        </div>
                                        <div class="col-md-1" style="text-align:center;">~</div>
                                        <div class="col-md-4" style="z-index: 1;">
                                            <div class="angularsl">
                                                {{Form::select('time_end', config('combobox.timelist'), $seminar->time_end)}}
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right">
                                        {{Form::text('position1', $seminar->position1, ['class'=>'form-control', 'placeholder'=>'都道府県・都市名'])}}
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right">
                                        {{Form::text('position2', $seminar->position2, ['class'=>'form-control', 'placeholder'=>'詳細場所'])}}
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right">
                                        {{Form::text('address', $seminar->address, ['class'=>'form-control', 'placeholder'=>'住所'])}}
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right">
                                        {{Form::number('particip_count', $seminar->particip_count, ['class'=>'form-control'])}}
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right">
                                        {{Form::number('particip_cost', $seminar->particip_cost, ['class'=>'form-control'])}}
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right">
                                        {{Form::textarea('lecturer', $seminar->lecturer, ['class'=>'form-control', 'rows'=>7])}}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right">
                                        {{Form::textarea('sponsor', $seminar->sponsor, ['class'=>'form-control', 'rows'=>7])}}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right">
                                        {{Form::text('inquiry_name', $seminar->inquiry_name, ['class'=>'form-control'])}}
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right">
                                        {{Form::textarea('inquiry', $seminar->inquiry, ['class'=>'form-control', 'rows'=>5])}}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right">
                                        {{Form::textarea('event_detail', $seminar->event_detail, ['class'=>'form-control', 'rows'=>14])}}
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right" style="height:163px;">
                                        <div class="col-md-8" style="padding-left: 0px; padding-right: 0px; top: 30%; position: absolute;">
                                            <div class="row">
                                                <div class="input-group">
                                                    <div class="has-feedback" style="margin-bottom:0px;">
                                                        {{Form::text('image_name', $seminar->image_name, ['class'=>'form-control', 'readonly'=>'readonly', 'placeholder'=>'表示画像', 'id'=>'thumbnail'])}}
                                            ...
                                            {{Form::text('url', $seminar->url, ['class'=>'form-control'])}}
                                        </div>   
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="gridcell-right" style="height:40px;">
                                        <input type="checkbox" name="publication_setting" value="2" @php if($seminar->publication_setting==1) echo 'checked' @endphp>掲載中 &nbsp; &nbsp; &nbsp;
                                        <input type="checkbox" name="publication_setting" value="3" @php if($seminar->publication_setting==2) echo 'checked' @endphp>掲載終了 &nbsp; &nbsp; &nbsp;
                                        <input type="checkbox" name="publication_setting" value="1" @php if($seminar->publication_setting==0) echo 'checked' @endphp>非掲載 &nbsp; &nbsp; &nbsp;
                                    </div>
                                </div>
                            </div>
