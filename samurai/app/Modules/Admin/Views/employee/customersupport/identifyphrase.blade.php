                ...
                <div class="row">
                        ...
                        <div class="sidebar-left">
                            <ul>
                                <ul>
	                                ...
	                                <!-- <li class="active"><a href="{{('/admin/employee/customersupport/identifyphrase')}}">本人確認書類対応設定</a></li> -->
                    ...
                    <div class="col-md-9 pull-right">
                        <div class="site-content">
                            ...
                            {{ Form::open(array('url' => 'admin/employee/customersupport/delIdentifyphrase/', 'method' =>'POST')) }}
                            ...
                            <div class="col-md-12" style="padding-left:50px;padding-right:50px;margin-top:30px;">
                                {{ Form::open(array('url' => 'admin/employee/customersupport/updateIdentifyphrase/', 'method' =>'POST')) }}
    ...
    <script>
        $(document).ready(function(){
            $('.tr_click').click(function(){
                var id = $(this).attr('id');
                $.ajax({
                    url: '/admin/employee/customersupport/getIdentifyphrasebyid/'+id,
                    dataType: 'JSON',
