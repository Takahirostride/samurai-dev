...
<div class="container">    
    <div class="row">
        <div class="col-xs-12">   
            @include('Asp::layouts.partial_file.breadcrumb',['page_name'=>'manage_client_index'])         
            ...
            <table class="table table-bordered table-list-user tbrow-link">
                ...
                <tbody>
                    @foreach($companies as $company)
                            @include('Asp::manage_user.content_company',['element'=>$company])
                    @endforeach
                </tbody>                
            </table>
            </form>
...
@push('script')
    ...
    @include('Asp::manage_user.modal_destroy')
    @include('Asp::manage_user.modal_destroy_success')
@endpush