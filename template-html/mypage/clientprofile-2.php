				...
				<div class="row">
					<div class="col-sm-12">
						<h4 class="pagerow-title">
							<span>プロフィール</span>
							<a href="mypage/clientprofile-1.php" class="btn-primary btn btn-style-shadow-green btn-success right-title">表示する</a>
						</h4>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12" >
					    ...
					    <p >創業14周年を迎え、日本国内で培ったノウハウを活かした海外での事業展開を加速させていきたいと考えております。</p>
					    </div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
						<h4 class="pagerow-title"><span>士業からの評価</span>
						</h4>
					</div>
				</div>
				<div class="row">
