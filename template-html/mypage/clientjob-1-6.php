		...
		<div class="row">
			...
			<div class="col-sm-10 mainpage">
                ...
                <div class="col-sm-10 clientjob-1-5">
                    ...
                    <div class="row">
                        <div class="col-sm-12 clientjob-tab mgt-20 mb20">
                            <ul class="nav nav-tabs tab-1">
                                ...
                                <li class="tab-style-grey active"><a href="mypage/clientjob-1-6.php">評価・実績 </a></li>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="pagerow-title"><span>今までの実績</span>
                            </h4>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="block-evaluation text-center">
                        <div class="col-sm-3 ">
