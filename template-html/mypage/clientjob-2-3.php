							...
							<div class="col-sm-9">
								<form action="" method="POST" role="form">
									...
									<p class="text-center mgt-30">
										<button type="submit" class="shadowbuttonsuccess btn btn-success">請求を修正する</button>
									</p>
								</form>
							</div>
							<div class="col-sm-3">
						...
						<div class="row boxcacular">
							<div class="col-sm-9">
								<form action="" method="POST" role="form">
									...
									<p class="text-center mgt-30">
										<button name="a" type="submit" class="shadowbuttonsuccess btn btn-success mgr-15">請求情報を確定する</button>
										<button name="b" type="submit" class="shadowbuttonsuccess btn btn-success">請求を修正する</button>
