                            ...
                            <div class="col-sm-12">
                                <form action="" method="POST" class="form-inline">
                                    ...
                                    <div class="form-group col-sm-2 text-right">
                                        <a href="mypage/clientjob-1-10.php" class="shadowbuttonprimary btn btn-primary">提案一覧を見る</a>
                                    </div>
                        ...
                        <table class="table table-bordered table-hover table-myjob full-table-click">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="td-link"><a href="mypage/clientjob-1-10.php">再エネコーディネーターを派遣します</a></td>
                                    <td class="td-link"><a href="mypage/clientjob-1-10.php">0件の質問</a></td>
                                    <td class="td-link"><a href="mypage/clientjob-1-10.php">設定・編集・掲載終了</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
