			...
			<div class="col-sm-8 mainpage">
				...
				<div class="row">
					<div class="col-sm-12 text-center">
                            <p class="mb20">
							     <a href="mypage/clientprofile-4.php" class="btn-primary btn btn-style-shadow-green btn-success">表示する</a>
                            </p>
					</div>
				</div>
                <div class="row">
                    <div class="col-sm-12 text-center" >
                        <table class="table table-bordered">
                            <tbody>
                                <tr ng-repeat="categoryitem in displayhopepartinfo.category" class="">
                                    <td >テキストテキスト</td>
                                    <td >テキストテキスト</td>
                                    <td >テキストテキスト</td>
                                    <td >テキストテキスト</td>
