		                    ...
		                    <div class="col-md-3 pull-left">
		                        <div class="sidebar-left">
		                            <ul>
		                                ...
		                                <li class="active"><a href="admin/employee/customersupport/contact.php">お問い合わせ対応設定</a></li>
		                            ...
		                            <div class="row" style="margin-left:0px;margin-right:0px;">
		                                <div class="section-5 col-md-12" style="display:block;">
		                                    <table>
		                                        ...
		                                        <tbody>
													<!-- ngRepeat: tableitem in tablearray --><tr ng-repeat="tableitem in tablearray" ng-click="edittemplate($index)" class="ng-scope" role="button" tabindex="0" style="">
														<td ng-click="$event.stopPropagation()" role="button" tabindex="0"><input type="checkbox" name="yes" ng-click="clickitemcheckbox(tableitem.id)" ng-checked="existitemcheckbox(tableitem.id)"></td>
														<td style="min-width:100px;" class="ng-binding">Not good</td>
														<td style="min-width:150px;" class="ng-binding"> Not passed</td>
														<td style="min-width:150px;" class="ng-binding">Not text</td>
													</tr><!-- end ngRepeat: tableitem in tablearray --><tr ng-repeat="tableitem in tablearray" ng-click="edittemplate($index)" class="ng-scope" role="button" tabindex="0">
														<td ng-click="$event.stopPropagation()" role="button" tabindex="0"><input type="checkbox" name="yes" ng-click="clickitemcheckbox(tableitem.id)" ng-checked="existitemcheckbox(tableitem.id)"></td>
														<td style="min-width:100px;" class="ng-binding">テスト</td>
														...
														<td style="min-width:150px;" class="ng-binding">テスト</td>
														<td style="min-width:150px;" class="ng-binding">テスト</td>
													</tr><!-- end ngRepeat: tableitem in tablearray -->
												</tbody>
		                                    </table>
		                                </div>
		                            </div>
