		                    ...
		                    <div class="col-md-3 pull-left">
		                        <div class="sidebar-left">
		                            <ul>
		                                ...
		                                <li class="active"><a href="admin/employee/customersupport/violatorphrase.php">違反者対応設定</a></li>
		                                    ...
		                                    <table>
		                                        ...
		                                        <tbody>
		                                            ...
		                                            <tr ng-repeat="tableitem in tablearray" ng-click="edittemplate($index)" class="ng-scope" role="button" tabindex="0" style="">
		                                                ...
		                                                <td style="min-width:105px;" class="ng-binding">未承認</td>
		                                                <td style="min-width:15px;" class="ng-binding">Violation1</td>
		                                                <td style="min-width:60px;" class="ng-binding">Violation1-title</td>
		                                                <td style="min-width:150px;" class="ng-binding">Violation1-text</td>
		                                            </tr>
		                                            ...
		                                            <tr ng-repeat="tableitem in tablearray" ng-click="edittemplate($index)" class="ng-scope" role="button" tabindex="0">
		                                                ...
		                                                <td style="min-width:105px;" class="ng-binding">承認</td>
		                                                <td style="min-width:15px;" class="ng-binding">Violation2</td>
		                                                <td style="min-width:60px;" class="ng-binding">Violation2</td>
		                                                <td style="min-width:150px;" class="ng-binding">Violation2</td>
		                                            </tr>
		                                            <!-- end ngRepeat: tableitem in tablearray -->
		                                        </tbody>
		                                    </table>
