		                ...
		                <div class="row">
		                    <div class="col-md-3 pull-left">
		                        <div class="sidebar-left">
		                            <ul>
		                                <li class="active"><a href="admin/employee/other/affiliate.php">アフィリエイター管理</a></li>
		                    ...
		                    <div class="col-md-9 pull-right">
		                        <div class="site-content">
		                            <div class="blueheading"><span>アフィリエイター情報一覧</span></div>
		                                    ...
		                                    <div class="col-md-5">
		                                        <form class="form-horizontal ng-pristine ng-valid">
		                                            <div class="form-group" style="margin-top:20px;">
		                                                <p class="col-sm-4">アフィリエイター</p>
		                                                <div class="col-sm-7">
		                                                    <input class="form-control ng-pristine ng-untouched ng-valid ng-empty" id="focusedInput" type="text" placeholder="アフィリエイター" ng-model="searchsetting.name" aria-invalid="false">
		                                                </div>
		                                            </div>
		                                        </form>
		                                    </div>
		                                ...
		                                <table>
		                                    <thead>
		                                        <tr>
		                                            ...
		                                            <th style="min-width:180px;">報酬合計</th>
		                                            <th style="min-width:180px;">集客数</th>
