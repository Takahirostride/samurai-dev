		                ...
		                <div class="row">
		                    <div class="col-md-3 pull-left">
		                        <div class="sidebar-left">
		                            <ul>
		                                <li class="active"><a href="admin/employee/data/subsidylist.php">助成金データ</a></li>
		                                        ...
		                                        <form class="form-horizontal ng-pristine ng-valid ng-valid-min">
		                                            <div class="form-group" style="margin-top:20px;">
		                                                ...
		                                                <div class="col-sm-8">
		                                                    ...
		                                                    <div class="col-sm-2" style="padding-left:0px;padding-right:0px; text-align: center;">
