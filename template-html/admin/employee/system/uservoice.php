		                    ...
		                    <div class="col-md-3 pull-left">
		                        <div class="sidebar-left">
		                            <ul>
		                                ...
		                                <li class="active"><a href="admin/employee/system/uservoice.php">利用者の声</a></li>
		                        ...
		                        <div class="site-content">
		                            ...
		                            <div class="section-3 col-md-12">
		                                <div style="float:left;padding-left:100px;">
		                                    <button class="submit-blue-btn" ng-click="addnewuservoice()">新規追加</button>
		                                </div>
		                            </div>
		                            <div class="section-3 col-md-12">
		                                <h4 style="background-color:#F4F4F4;margin-left:10px;">利用者の声一覧</h4>
		                                <div class="section3-full">
		                                    <div class="section3-full-scroll">
		                                        <!-- ngRepeat: voiceitem in voicearray -->
		                                    </div>
		                                </div>
		                            </div>
		                            ...
		                            <div style="margin-top:50px;">
		                                <input type="submit" name="submit" class="submit-blue-btn" value="保存する" ng-click="savevoicearray()">
		                            </div>
		                        </div>
		                    </div>
		                </div>
