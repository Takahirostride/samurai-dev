		                    ...
		                    <div class="col-md-3 pull-left">
		                        <div class="sidebar-left">
		                            <ul>
		                                ...
		                                <li class="active"><a href="admin/employee/system/alim.php">お知らせ</a></li>
		                        ...
		                        <div class="site-content">
		                            ...
		                            <div class="section-3 col-md-12">
		                                <div style="float:left;padding-left:100px;">
		                                    <button class="submit-blue-btn" ng-click="addnewalim()">新規追加</button>
		                                </div>
		                            </div>
		                            <div class="section-3 col-md-12">
		                                ...
		                                <div class="section3-full">
		                                    <div class="section3-full-scroll">
		                                        <!-- ngRepeat: alimitem in alimarray -->
		                                    </div>
		                                </div>
		                            </div>
		                            ...
		                            <div style="margin-top:50px;">
		                                <input type="submit" name="submit" class="submit-blue-btn" value="保存する" ng-click="savealimarray()">
		                            </div>
		                        </div>
		                    </div>
		                </div>
