	            ...
	            <div class="header ng-scope">
	                ...
	                <div class="header-bottom">
	                    <ul class="navbar" style="margin-bottom:0px;">
	                        ...
	                        <li class="active"><a href="admin/employee/balance/sale.php">収支管理</a></li>
		                ...
		                <div class="row">
		                    <div class="col-md-3 pull-left">
		                        <div class="sidebar-left">
		                            <ul>
		                                <li class="active"><a href="admin/employee/balance/sale.php">売上管理</a></li>
		                                <li><a href="admin/employee/balance/depwith.php">入出金管理</a></li>
		                                <li><a href="admin/employee/balance/payplan.php">支払予定管理</a></li>
		                            </ul>
		                        </div>
		                    </div>
