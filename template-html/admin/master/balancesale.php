                        ...
                        <div class="row">
                            <div class="col-md-3 pull-left">
                                <div class="sidebar-left">
                                    <ul>
                                        <li class="active"><a href="admin/master/balancesale.php">売上管理</a></li>
                                                ...
                                                <form class="form-horizontal ng-pristine ng-valid ng-valid-min ng-valid-max">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-3" style="padding-right:0px;">
                                                            <input class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-min ng-valid-max" type="number" ng-model="search.created_time_from_year" min="2018" max="2100" aria-invalid="false">
                                                        </div>
                                                        <p class="col-sm-1" style="padding-right:0px;">年</p>
                                                        <div class="col-sm-1" style="padding-left:0px;padding-right:0px;">
                                                            <input class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-min ng-valid-max" type="number" ng-model="search.created_time_from_month" min="1" max="12" aria-invalid="false">
                                                        </div>
                                                        <p class="col-sm-1" style="padding-right:0px;">月</p>
                                                        <div class="col-sm-1" style="padding-left:0px;padding-right:0px;">
                                                            <input class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-min ng-valid-max" type="number" ng-model="search.created_time_from_day" min="1" max="31" aria-invalid="false">
                                                        </div>
                                                ...
                                                <form class="form-horizontal ng-pristine ng-valid ng-valid-min ng-valid-max">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-3" style="padding-left:0px;padding-right:0px;">
                                                            <input class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-min ng-valid-max" type="number" ng-model="search.created_time_to_year" min="2018" max="2100" aria-invalid="false">
                                                        </div>
                                                        <p class="col-sm-1" style="padding-right:0px;">年</p>
                                                        <div class="col-sm-1" style="padding-left:0px;padding-right:0px;">
                                                            <input class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-min ng-valid-max" type="number" ng-model="search.created_time_to_month" min="1" max="12" aria-invalid="false">
                                                        </div>
                                                        <p class="col-sm-1" style="padding-right:0px;">月</p>
                                                        <div class="col-sm-1" style="padding-left:0px;padding-right:0px;">
                                                            <input class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-min ng-valid-max" type="number" ng-model="search.created_time_to_day" min="1" max="31" aria-invalid="false">
                                                        </div>
                                                        <p class="col-sm-1" style="padding-right:0px;">日</p>
                                                    </div>
                                                </form>
                                            ...
                                            <div class="col-md-5">
                                                <form class="form-horizontal ng-pristine ng-valid">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-3" style="padding-right:0px;">
                                                            <input class="form-control ng-pristine ng-untouched ng-valid ng-empty" type="text" ng-model="searchsetting.name" aria-invalid="false">
                                                        </div>
                                                        <p class="col-sm-1" style="padding-right:0px;">年</p>
                                                        <div class="col-sm-1" style="padding-left:0px;padding-right:0px;">
                                                            <input class="form-control ng-pristine ng-untouched ng-valid ng-empty" type="text" ng-model="searchsetting.name" aria-invalid="false">
                                        ...
                                        <div class="row" style="margin-bottom:20px;margin-top:20px;">
                                            ...
                                            <div class="col-sm-12">
                                                <form class="searchPart ng-pristine ng-valid">
                                                    ...
                                                    <!-- <button type="button" class="submit-blue-searchright" style="margin-left:10px;">売上表印刷</button> -->
                                                    <a href="csv/down_balance_sale" class="submit-blue-searchright" style="margin-right:20px;">csv出力</a>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
