<?php include ('./inc/header2.php'); ?>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-10">
                        <p class="list-heading">施策一覧（保存リストを見る）</p>
                        <p class="list-pages">1000件　（1件～25件表示）</p>
                        <div class="list-rows">
                            <div class="row">
                                <div class="p-item">
                                    <div class="col-xs-2">
                                    ...
                                    <div class="col-xs-8 policy-link" onclick="window.location.href='policy_detail.php';">
                                        <p class="pitem-title">「中小企業経営改善資金」</p>
                                        <div class="pmeta-tags">
                                            <a href="#">小規模事業</a>
                                            <a href="#">中小企業</a>
                                            <a href="#">融資支援</a>
                                        </div>
                                        <p class="pmeta-region">登録期関:東京都 渋谷区 / 募集時期:随時</p>
