	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<ul class="dtabprofile tab-profile nav nav-tabs">
					<li class="tab-style-grey active"><a href="client/Fask-1.php"> 施策詳細</a></li>
					<li class="tab-style-grey"><a href="client/Fask.php"> 依頼詳細</a></li>
				</ul>
		...
		　　　　　　TEL 048-851-6391 / FAX 048-851-6392</p>
									<div class="text-center">
										<div class="text-center">
											<a href="client/Fask-1.php" data-dismiss="modal" class="btn-primary btn btn-style-shadow-green btn-success mgr-15">確認する</a>
											<a href="client/Fask.php" class="btn btn-style-shadow-grey">戻る</a>
										</div>
									</div>
								</div><!-- end .sdetail -->
							</div><!-- end left-detail -->
							<div class="col-xs-4">
								<div class="detail-right-mbox">
									<div class="checkbox">
										<label>
											<input type="checkbox" checked="checked">次回から自動的にログインする。 
										</label>
									</div> <!-- end .checkbox -->
