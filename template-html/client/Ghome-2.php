...
<div class="mainpage">
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12 mainpage clientjob-1-4">
                <div class="row">
                    <div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-sm-12">
                         <p class="tit1">横浜市 IoT 導入スタートアップ補助金</p>
                ...
                <div class="row">
                    <div class="col-sm-12 font17">
                        <p class="h1-left-border"><b>登録機関</b></p>
                        <p class= text1">神奈川県 横浜市</p>
                        <p class="h1-left-border"><b>対象地域</b></p>
                        <p class= text1">神奈川県横浜市</p>
                        <p class="h1-left-border"><b>更新日</b></p>
                        <p class= text1">2017年11月24日</p>
                        <p class="h1-left-border"><b>施策名</b></p>
                        <p class= text1">生産性向上のためのＩｏＴ等の導入支援</p>
                        <p class="h1-left-border"><b>目的</b></p>
                        <p class= text1">中小企業が生産性向上のために導入する、IoT等の費用の１／２（最大10万円）を補助します。少額・簡単なIoT導入のスタートアップ支援です。ぜひご活用ください。</p>
                        <p class="h1-left-border"><b>対象者の詳細</b></p>
                        <p class= text1">○補助対象者の主な要件<br />（１） 設備を設置する拠点（本社、支社、工場、研究所( 部門) 等）が横浜市内にあり、中小企業であること<br />（２） IoT 等の設置によって生産性向上が見込まれること<br />（３） 申請年度の 2 月末日までに設置及び実績報告を行うこと<br />（４） 創業から 12 月を経過していること<br />（５） 申請年度及び過去において本補助金の交付を受けていないこと<br />※詳細については、ホームページまたは募集案内をご覧ください。</p>
                        <p class="h1-left-border"><b>支援内容・支援規模</b></p>
                        <p class= text1">補助対象事業<br />平成31年2月28日（木）までに契約、取得、実施及び支払が全て完了した、以下のものが対象です。<br />（１） センサー及びデバイス（設置費用を含む。）<br />（２） データを送受信するための装置（設置費用を含む。）<br />（３） ソフトウェア<br />（４） リース料（導入開始年度分のみ対象とする。）<br />（５） データを蓄積・分析を行うためのクラウド費用<br />（６） コンサルタント委託経費<br />（７） その他市長が補助対象として適当であると認めるも
                        〇補助対象事業<br />平成31年2月28日（木）までに契約、取得、実施及び支払が全て完了した、以下のものが対象です。<br />（１） センサー及びデバイス（設置費用を含む。）<br />（２） データを送受信するための装置（設置費用を含む。）<br />（３） ソフトウェア<br />（４） リース料（導入開始年度分のみ対象とする。）<br />（５） データを蓄積・分析を行うためのクラウド費用<br />（６） コンサルタント委託経費<br />（７） その他市長が補助対象として適当であると認める</p>
                        <p class="h1-left-border"><b>募集期間</b></p>
                        <p class= text1">平成30年5月7日（月）午前9時 から 12月27日（木）午後5時まで</p>
                        <p class="h1-left-border"><b>対象期間</b></p>
                        <p class= text1">平成31年2月28日（木）までに契約、取得、実施及び支払いが全て完了し、実績報告が行われたもの</p>
                        <p class="h1-left-border"><b>pdfデータ</b></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <button type="button" class="btn btn-success btn-style-shadow-green">選びなおす</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
