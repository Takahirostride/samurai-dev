	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<ul class="dtabprofile tab-profile nav nav-tabs">
					...
					<li class="tab-style-grey"><a href="client/Fselect-1.php"> 依頼詳細</a></li>
				</ul>
		...
		　　　　　　TEL 048-851-6391 / FAX 048-851-6392</p>
									<div class="text-center">
										<button onclick="window.history.back();" class="btn btn-success sdetail-back-btn btn-style-shadow-green">戻る</button>
									</div>
								</div><!-- end .sdetail -->
							</div><!-- end left-detail -->
							<div class="col-xs-4">
									<div class="detail-right-mbox">
										...
										<div class="pull-right mgt-10">
											<img src="assets/images/manual.png" height="30px" data-toggle="modal" data-target="#myModal">
											<button type="button" onclick="window.location.href='client/Fask.php';" class="btn-primary btn btn-xs btn-style-shadow-green btn-success mgl-15">提案する</button>
										</div>
									</div> <!-- end .detail-right-mbox -->
								<div class="dclient-list-right">
									<div class="dclient-list-item">
