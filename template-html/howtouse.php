<?php include ('./inc/header_nologin.php'); ?>
	<div class="mainpage">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-3">
					<div class="howtouse-sidebar-left text-center">
						<p class="bg-color">申請代行者を決定しよう</p>
						<ul>
							<li class="active"><a href="./howtouse.php"><strong>①依頼しよう</strong></a></li>
							<li class=""><a href="./howtouse-2.php"><strong>②募集しよう</strong></a></li>
							<li class=""><a href="./howtouse-3.php"><strong>③提案を選ぶ</strong></a></li>
						</ul>
						<p class="bg-color">申請をしよう</p>
						<ul>
							<li class=""><a href="./howtouse-4.php"><strong>①プロジェクトの開始</strong></a></li>
							<li class=""><a href="./howtouse-5.php"><strong>②計画の進行</strong></a></li>
							<li class=""><a href="./howtouse-6.php"><strong>③プロジェクトの完了</strong></a></li>
						</ul>
					</div>
				</div>
				<div class="col-sm-9">
					...
					<div class="howtouse-step">
						...
						<table class="table-howtouse">
							<tbody>
								<tr>
									<td class="td-max">
										<img class="img-full" src="assets/images/howtouse_img1_1.jpg">
									</td>
									<td>
					...
					<div class="howtouse-step">
						...
						<table class="table-howtouse">
							<tbody>
								<tr>
									<td class="td-max">
										<img class="img-full" src="assets/images/howtouse_img1_2.jpg">
									</td>
									<td>
										<label class="useredcirclenumber">1</label>
										<span>
					...
					<div class="howtouse-step">
						...
						<p>
							<img class="img-full" src="assets/images/howtouse_img1_3.jpg">
						</p>
						<p class="mgt-30">
							<label class="useredcirclenumber">1</label>
					...
					<div class="howtouse-step mgbt-30">
						...
						<p>
							<img class="img-full" src="assets/images/howtouse_img1_4.jpg">
						</p>
						<p class="mgt-30">
							<label class="useredcirclenumber">1</label>
