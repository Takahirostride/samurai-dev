	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12 mainpage">
                ...
                </div><!-- end .clientjob-1-4 -->
                <div class="text-center bsearch-btn-s">
                    <button type="submit" class="btn btn-success btn-style-shadow-green mgr-15 w120px">選択する</button>
                       <button class="btn btn-default btn-style-shadow-grey w120px" type="button">戻る</button>
                </div>
                </form>
			</div> <!-- end .mainpage -->
		</div> <!-- end .row -->
