	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-2 sidebar-left">
				...
				<p><a href="agency/Bsubsidylist.php" class="btn btn-default sidebar-btn btn-grad">
						<strong>提案を検討リスト</strong>
					</a></p>
				<p><a href="agency/Bsubsidylist-1.php" class="btn btn-default btn-grad sidebar-btn active">
						<strong>興味リスト</strong>
					</a></p>
				<p><a href="agency/Bsubsidylist-1.php" class="btn btn-default btn-grad sidebar-btn">
							...
							<div class="row">
								<div class="subsidy-list-col1">
									<div class="index-boxcol2-sub">
										<div class="dtags-track">
											<label>小規模事業..</label>
											<label>融資支援</label>
											<label>中小企業</label>
										</div>
											<div class="create-link-box">
												<a href="agency/Bselect-B17.php"></a>
												...
												<div class="right-boxcol2">
													...
													<p>
														<a href="agency/Bselect-B17.php" class="boxcol2-a-2"><span class="sidy-tbig">群馬県特別小口資金</span>
															<br><strong>登録期関:</strong>群馬県 すべて   /    <strong>募集時期:</strong>毎年4月1日から3月31日まで</a>
														<span>特別小口資金</span>
													</p>
												</div>
							...
							<div class="row">
									...
									<div class="index-boxcol2-sub">
										<div class="dtags-track">
											...
											<div class="create-link-box">
												<a href="agency/Bselect-B17.php"></a>
												<div class="left-boxcol2">
													<img src="assets/images/agency-list-02.jpg" alt="">
												</div>
												<div class="right-boxcol2">

													<p>
														<a href="agency/Bselect-B17.php" class="boxcol2-a-2"><span class="sidy-tbig">横浜市中小企業融資制度</span><br><strong>登録期関:</strong>神奈川県 横浜市   /   <strong>募集時期:</strong>毎年4月1日から3月31日まで</a>
											...
											<div class="middle-boxcol2">
												<ul>
													<li><button type="button" class="btn btn-warning" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="お気に入りボタンの１つで、興味がある施策を保存しておくことができます。興味がある施策を保存しておくことで、自動検索でよりあなたに合った施策が提案されます。">提案を検討</button></li>
													<li><button type="button" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="お気に入りボタンの１つで、興味がある施策を保存しておくことができます。興味がある施策を保存しておくことで、自動検索でよりあなたに合った施策が提案されます。">興味あり</button></li>
													<li><button type="button" class="btn btn-default btn-style-grey btn-default-select" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="必要がない、自分に関係がない施策が表示された場合は、非表示としてください。非表示とすることで自動検索であなたに関連しない施策が表示されなくなります。">非表示</button></li>
												</ul>
												<p class="jprice">融資支援：2億8,000万円</p>
											</div> <!-- end .middle-boxcol2 -->
									</div> <!-- end item index-boxcol2 -->
								...
								<div class="subsidy-list-col2">
									<div class="subsidylist-item-av div-style-grey">
										...
										<button class="btn-primary btn-follow btn-style-grey">フォロー</button>
										</div>
									</div>
								</div><!-- end col-sm-3 -->
								<div class="subsidy-list-col3">
