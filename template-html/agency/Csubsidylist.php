	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12 mainpage">
				<div class="row">
			        <div class="col-sm-12">
			            <p class="text-step "><b><span>STEP1</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;対応可能施策情報の選択</b><img id="btn-open-modal" src="assets/images/manual.png" style="cursor:pointer;" height="20px" data-toggle="modal" data-target="#modal-registration-policy3"></p>
			        </div>
			    </div>
						...
						<div class="subsidy-list-item">
							<div class="row">
								...
								<div class="col-sm-2 text-center">
									<a href="#" class="btn btn-success  btn-style-shadow-green mgt-20 mb20">選択する</a>
								</div><!-- end col-sm-1 -->
							</div> <!-- end .row -->
