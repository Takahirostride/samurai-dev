		...
		<div class="row">
			<div class="col-sm-12">
				...
				<ul class="dtabprofile tab-profile nav nav-tabs">
					<li class="tab-style-grey"><a href="#"> 施策詳細</a></li>
					<li class="tab-style-grey active"><a href="agency/Bselect-1.php"> 依頼詳細</a></li>
				</ul>
						...
						<div class="row">
							...
							<div class="col-xs-4">
								<div class="detail-right-mbox">
									<div class="checkbox">
										<label>
											<input type="checkbox" class="dask-check checkall-btn" checked="checked">チェックした士業にメッセージを送る /提案をする
										</label>
									</div> <!-- end .checkbox -->
